...
const data = [{
  "image": "expo-logo.png",
  "text": "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident, voluptatem?"
  }, {
  "image": "expo-logo.png",
  "text": "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident, voluptatem?"
  }, {
...
const LandingPage = () => {
  return (
    <>
      ...
      <div className='flex justify-center mx-[20px] flex-grow'>
        <div className='h-[100vh] max-w-[1200px]'>
          ...
          <p></p>
          <Info />
          <div className='mt-40 grid grid-cols-2 md:grid-cols-3'>
            {data.map(empresa => <Dropdown key={empresa.image} data={empresa}/>)}
          </div>
        </div>
      </div>
        {/* <Footer /> */}
